package com.kophe.le_sklad_zradn.screens.createissuance.viewmodel
...
class CreateIssuanceViewModel @Inject constructor(
    ...
    private suspend fun submitItem() {
        ...
        performTask<Any?, LSError>({
            issuanceRepository.createIssuance(
                items = selectedItems.toMutableList(), IssuanceInfoContainer(
                    from,
                    receiver,
                    location,
