package com.kophe.le_sklad_zradn.screens.createissuance.view
...
import com.kophe.le_sklad_zradn.databinding.FragmentCreateIssuanceBinding
...
import com.kophe.le_sklad_zradn.screens.createissuance.view.CreateIssuanceFragmentDirections.actionCreateIssuanceFragmentToSelectItemsFragment
...
class CreateIssuanceFragment :
    BaseViewModelFragment<FragmentCreateIssuanceBinding, CreateIssuanceViewModel>() {
    ...
    override fun createViewModel() =
        ViewModelProvider(this, factory)[CreateIssuanceViewModel::class.java]
    ...
    private fun viewModelSubscriptions() {
        viewModel.viewModelEvent.observe(viewLifecycleOwner) {
            if (it == Done) {
                NavHostFragment.findNavController(this@CreateIssuanceFragment).previousBackStackEntry?.savedStateHandle?.set(
                    "UPDATE", true
                )
    ...
    override fun onCreateView(
        ...
        val binding = FragmentCreateIssuanceBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let { bundle ->
            val args = CreateIssuanceFragmentArgs.fromBundle(bundle)
            loggingUtil.log("screen started in CREATE mode")
            binding?.buttonCreate?.setOnClickListener {
                navigate(
                    actionCreateIssuanceFragmentToSelectItemsFragment(null)
                )
            }
