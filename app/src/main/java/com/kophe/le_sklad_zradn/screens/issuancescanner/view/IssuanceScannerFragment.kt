package com.kophe.le_sklad_zradn.screens.issuancescanner.view
...
import com.kophe.le_sklad_zradn.databinding.FragmentIssuanceScannerBinding
...
const val ISSUANCE_ITEMS_KEY = "issuance_items_key"

class IssuanceScannerFragment : BaseFragment<FragmentIssuanceScannerBinding>() {
    ...
    private val callback = BarcodeCallback { result ->
        ...
        pause()
        findNavController(this@IssuanceScannerFragment).previousBackStackEntry?.savedStateHandle?.set(
            ISSUANCE_ITEMS_KEY, result.text
        )
        navigateUp()
    }
    ...
    override fun onCreateView(
        ...
        val binding = FragmentIssuanceScannerBinding.inflate(inflater, container, false)
...
//        }
    ...
    private fun setupResult() {
        findNavController(this@IssuanceScannerFragment).previousBackStackEntry?.savedStateHandle?.set(
            ISSUANCE_ITEMS_KEY, items.firstOrNull()
        )
    }
